...
type
  ...
  public
    ...
    constructor Create(_number: string; _name: string; _parent: TSieDimension;
      _isDefault: boolean);
  end;
...
constructor TSieDimension.Create(_number: string; _name: string;
  _parent: TSieDimension; _isDefault: boolean);
begin
  self.Number := _number;
  self.Name := _name;
  self.IsDefault := _isDefault;
