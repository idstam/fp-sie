...
uses
  Classes, SysUtils, USieClasses, Generics.Collections, USieCompany,
  USieAccount, USieDimension, USiePeriodvalue, USieBookingYear, USieVoucher;
...
begin
  ...
  self.DIM.AddOrSetValue('2', TSieDimension.Create('2', 'Kostnadsbärare',
    DIM['1'], True));
